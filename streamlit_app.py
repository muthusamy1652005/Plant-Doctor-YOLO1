...
st.markdown("""
    ...
    /* Sidebar Background - Light Green */
...
# --- 3. TAMIL DISEASE DATABASE (Updated Septoria) ---
disease_info = {
    # TOMATO
    "Tomato_Early_Blight": { 
        ...
        "solution": "💊 **தீர்வு:** மாங்கோசெப் (Mancozeb) அல்லது குளோரோதலானில் (Chlorothalonil) மருந்தை தெளிக்கவும். பாதிக்கப்பட்ட இலைகளை அகற்றவும்." 
    },
    "Tomato_Late_Blight": { 
    ...
    "Tomato_Yellow_Leaf_Curl_Virus": { 
        ...
        "solution": "💊 **தீர்வு:** இது வெள்ளை ஈக்களால் பரவுகிறது. வேப்ப எண்ணெய் அல்லது இமிடாகுளோப்ரிட் (Imidacloprid) தெளிக்கவும்." 
    },
    "Tomato_Leaf_Mold": { 
    ...
    # UPDATED SEPTORIA ENTRY BELOW 👇
    "Tomato_Septoria_Leaf_Spot": { 
        "name": "தக்காளி - இலைப்புள்ளி நோய் (Septoria Leaf Spot)", 
        "status": "Diseased", 
        "description": "இலைகளில் சிறிய வட்ட வடிவ புள்ளிகள் தோன்றும். புள்ளியின் நடுவில் சாம்பல் நிறமும், ஓரத்தில் கருப்பு வளையமும் இருக்கும். இது இலைகளை மஞ்சளாக மாற்றி உதிரச் செய்யும்.", 
        "solution": "💊 **மருந்து:** குளோரோதலானில் (Chlorothalonil) அல்லது காப்பர் பூஞ்சைக் கொல்லியை (Copper Fungicide) தெளிக்கவும்.\n💧 **பராமரிப்பு:** செடியின் இலைகள் மீது நீர் தெளிக்காமல், வேர்ப்பகுதியில் மட்டும் நீர் பாய்ச்சவும். பாதிக்கப்பட்ட இலைகளை உடனே அகற்றிவிடவும்." 
    },
    "Tomato_Spider_Mites_Two_spotted_spider_mite": { 
        "name": "தக்காளி - சிலந்தி பேன் (Spider Mites)", 
        "status": "Diseased", 
        "description": "இலைகளில் மஞ்சள் நிறப்புள்ளிகள் தோன்றும். இலைகளுக்கு அடியில் மெல்லிய வலை பின்னப்பட்டிருக்கும்.", 
        "solution": "💊 **தீர்வு:** அக்காரைடு (Acaricide) அல்லது கந்தகத் தூள் (Sulfur) பயன்படுத்தவும். தண்ணீரை பீய்ச்சி அடிக்கவும்." 
    },
    "Tomato_Target_Spot": { 
        "name": "தக்காளி - டார்கெட் ஸ்பாட்", 
        "status": "Diseased", 
        "description": "அடர் பழுப்பு நிற புள்ளிகள், குறி பாப்பது போன்ற வளையங்களுடன் காணப்படும்.", 
        "solution": "💊 **தீர்வு:** ஃப்ளூopyram போன்ற பூஞ்சைக் கொல்லிகளை தெளிக்கவும்." 
    },
    "Tomato_Mosaic_virus": { 
        ...
        "solution": "💊 **தீர்வு:** இதற்கு மருந்து இல்லை. பாதிக்கப்பட்ட செடியை உடனே வேரோடு பிடுங்கி எரித்துவிடவும். வைரஸ் இல்லாத விதைகளை பயன்படுத்தவும்." 
    },
    "Tomato_Healthy": { 
        "name": "ஆரோக்கியமான தக்காளி செடி (Healthy)", 
        "status": "Healthy", 
        "description": "செடி செழிப்பாகவும், இலைகள் பசுமையாகவும் உள்ளன. நோய் அறிகுறிகள் இல்லை.", 
    ...
    "Potato_Late_Blight": { 
        ...
        "status": "Diseased", 
        "description": "இலைகள் விளிம்பிலிருந்து அழுகி துர்நாற்றம் வீசும். குளிர்ந்த மற்றும் ஈரப்பதமான காலநிலையில் இது வேகமாக பரவும்.", 
        "solution": "💊 **தீர்வு:** காப்பர் ஆக்சிகுளோரைடு மருந்துகளை தெளிக்கவும். பாதிக்கப்பட்ட செடிகளை அழிக்கவும்." 
    },
    "Potato_Healthy": { 
        "name": "ஆரோக்கியமான உருளைக்கிழங்கு", 
        "status": "Healthy", 
        "description": "செடி நன்றாக உள்ளது. பூச்சி தாக்குதல் இல்லை.", 
        "solution": "✅ **பராமரிப்பு:** நீர் நிர்வாகம் அவசியம். வேர் அழுகலை தடுக்க நீர் தேங்காமல் பார்த்துக்கொள்ளவும்." 
    },

    # PEPPER
    "Pepper__bell___Bacterial_spot": { 
        "name": "மிளகாய் - பாக்டீரியா இலைப்புள்ளி", 
        "status": "Diseased", 
        "description": "இலைகளில் நீர் தேங்கியது போன்ற சிறிய புள்ளிகள் தோன்றி, பின் பெரிதாகி காய்ந்துவிடும்.", 
        "solution": "💊 **தீர்வு:** ஸ்ட்ரெப்டோமைசின் (Streptomycin) மற்றும் காப்பர் மருந்தை கலந்து தெளிக்கவும்." 
    },
    "Pepper__bell___Healthy": { 
        "name": "ஆரோக்கியமான மிளகாய் செடி", 
        "status": "Healthy", 
        "description": "செடி பசுமையாக உள்ளது. காய்கள் நன்றாக வளர்கின்றன.", 
        "solution": "✅ **பராமரிப்பு:** பூச்சி தாக்குதலை கண்காணிக்கவும். நுண்ணூட்டச்சத்து கலவை தெளிக்கவும்." 
    }
}
...
# ==========================================
    ...
    c1, c2 = st.columns(2)
    with c1:
        st.markdown('<div class="method-box box-blue"><p>1. Data Collection</p><span style="font-weight:normal; font-size:14px;">PlantVillage தரவுத்தொகுப்பு பயன்படுத்தப்பட்டது (54,306 படங்கள்).</span></div>', unsafe_allow_html=True)
        st.markdown('<div class="method-box box-green"><p>3. Model Training</p><span style="font-weight:normal; font-size:14px;">Google Colab T4 GPU மூலம் YOLOv8 Nano மாடல் பயிற்சி அளிக்கப்பட்டது.</span></div>', unsafe_allow_html=True)
    with c2:
        st.markdown('<div class="method-box box-yellow"><p>2. Preprocessing</p><span style="font-weight:normal; font-size:14px;">Roboflow மூலம் தரவு தயார் செய்யப்பட்டது (640x640 Resolution).</span></div>', unsafe_allow_html=True)
        st.markdown('<div class="method-box box-red"><p>4. Deployment</p><span style="font-weight:normal; font-size:14px;">Streamlit Cloud மூலம் டிப்ளாய் செய்யப்பட்டது.</span></div>', unsafe_allow_html=True)
